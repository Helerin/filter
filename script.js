...
const filtrarPorAssunto = (contatos, filtro) => {
    console.log(filtro + ': >>>>>>>>>>>>')
    return contatos.filter(contato => contato.assunto === filtro);
}

const contatosDuvida = filtrarPorAssunto(contatos, "Dúvida");
console.log(contatosDuvida);

const contatosSuporte = filtrarPorAssunto(contatos, "Suporte Técnico");
console.log(contatosSuporte);
